...
func Map(m game.Map, p game.Player) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/map.templ`, Line: 60, Col: 122}
		}
		...
		for y := m.Length - 1; y >= 0; y-- {
			for x := 0; x < m.Width; x++ {
				...
				if room, explored := m.Explored[current_pos]; explored {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `templ/map.templ`, Line: 77, Col: 63}
					}
